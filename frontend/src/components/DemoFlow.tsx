...
export function DemoFlow({ active, onShock, onRunCycle }: { active: number; onShock: () => void; onRunCycle: () => void }) {
  return (
    <section id="sec-demo" className="section wrap" data-screen-label="Demo Flow">
      ...
      <div className="section-header" style={{ marginTop: 36 }}>
        ...
        <div className="section-kicker">
          Phase 4 wires the visible steps to backend-first actions; the full auto-sequence is planned for Phase 5.
        </div>
      ...
      <div className="demo-strip">
        {steps.map((step, index) => (
          <div key={step.title} className={"demo-step" + (active === index ? " active" : "")}>
